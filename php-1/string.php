...
*/
    ...
    $first_sentence = "Hello PHP!" ; // Panjang string 10, jumlah kata 2
        ...
        echo "Panjang string pada Hello PHP adalah $hasil"."<br>";

        $hasil = str_word_count($first_sentence);
        echo "Jumlah kata nya adalah $hasil"."<p>";

    $second_sentence = "I'm ready for the challenges"; // Panjang string 28, jumlah kata: 5
        $hasil = strlen($second_sentence);
        echo "Panjang string pada kalimat I'm ready for the challenges adalah $hasil"."<br>";

        $hasil = str_word_count($second_sentence);
        echo "Jumlah kata dalam kalimat i'm ready for the challenges adalah $hasil"."<p>";
